...
const StatisticalAnalysisPlanModal = ({setIsStatisticalAnalysisPlanModalOpen}) => {
    return (
        <React.Fragment>
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            <div className="modal-header">
                                ...
                                <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={() => setIsStatisticalAnalysisPlanModalOpen(false)}></button>
                            </div>
                                                            ...
                                                            <div id="panelsStayOpen-collapse_SubOne" className="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-heading_SubOne">
                                                                <div className="accordion-body">
                                                                    <ul className="modal_inner_list">
                                                                        ...
                                                                        <li ><Link to="#">Indication: Immunology</Link></li>
                                                    ...
                                                    <div className="accordion sub_accor" id="accordionPanelsStayOpenExample">
                                                        <div className="accordion-item">
                                                            ...
                                                            <div id="panelsStayOpen-collapse_SubThree" className="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-heading_SubThree">
                                                                <div className="accordion-body">
                                                                    <ul className="modal_inner_list">
                                                                        <li><Link to="/selected-statistical-analysis">Indication: Asthma (AS)</Link></li>
                                                                        <li><Link to="#">Indication: Eosinophilic Esophagitis (EOE)</Link></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                            ...
                            <div className="modal-footer">
                                <Link to="/statistical-analysis-plan-manage-project" className="btn btn-primary"
                                    onClick={() => setIsStatisticalAnalysisPlanModalOpen(false)
                                    }>Add Project</Link>
                            </div>
                        </div>
                    </div>
...
export default StatisticalAnalysisPlanModal;
