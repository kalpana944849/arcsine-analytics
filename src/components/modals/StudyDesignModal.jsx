...
const StudyDesignModal = ({setIsStudyDesignProjectsModalOpen}) => {
    return (
        <React.Fragment>
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title" id="exampleModalLabel">Select Study</h5>
                                <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={() => setIsStudyDesignProjectsModalOpen(false)}></button>
                            </div>
...
export default StudyDesignModal;
