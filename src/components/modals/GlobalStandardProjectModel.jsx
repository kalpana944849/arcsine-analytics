...
const GlobalStandardProjectModel = ({setIsGlobalModalOpen}) => {
    return (
        <React.Fragment>
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            <div className="modal-header">
                                ...
                                <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={() => setIsGlobalModalOpen(false)}></button>
                            </div>
                                                            ...
                                                            <div id="panelsStayOpen-collapse_SubOne" className="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-heading_SubOne">
                                                                <div className="accordion-body">
                                                                    <ul className="modal_inner_list">
                                                                        ...
                                                                        <li><Link to="/selected-project-global-standards">Indication: Asthma (AS)</Link></li>
...
export default GlobalStandardProjectModel;
