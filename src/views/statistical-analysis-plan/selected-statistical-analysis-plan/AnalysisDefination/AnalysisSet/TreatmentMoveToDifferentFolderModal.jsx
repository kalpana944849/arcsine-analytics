...
const DATA_ITEM_KEY = "sapTreatmentTypeGuid";
const SELECTED_FIELD = "selected";
const idGetter = getter(DATA_ITEM_KEY);

const TreatmentMoveToDifferentFolderModal = ({ closeModal, treatmentsData }) => {
    let expandObj = {};
    const sapCollectionData = treatmentsData || [];
    const dataTreeCate = createDataTree(
        sapCollectionData,
        (i) => i.sapTreatmentTypeId,
        (i) => i.parentId,
        subItemsField
    );
            ...
            cell: (props) => {
                return (
                    <CustomCell
                        ...
                        onRowClick={() => { }}
                        expandIconClick={() => { }}
                        icon={"fas fa-light fa-database"
                            // props.dataItem?.sapId?.includes("SapDataCollectionId")
...
export default TreatmentMoveToDifferentFolderModal;