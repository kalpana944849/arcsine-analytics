...
const AnaSetMoveToDifferentFolderModal = ({ closeModal, analysisSetData }) => {
    let expandObj = {};
    const sapCollectionData = analysisSetData || [];
                ...
                return (
                    <CustomCell
                        ...
                        icon={"fas fa-light fa-database"
                            // props.dataItem?.sapAnalysisSetId?.includes("SapDataCollectionId")
...
export default AnaSetMoveToDifferentFolderModal;