...
const EndpointMoveToDifferentFolderModal = ({ closeModal }) => {
    let expandObj = {};
    const sapCollectionData = JSON.parse(localStorage.getItem("dataEndpoint")) || [];
...
export default EndpointMoveToDifferentFolderModal;