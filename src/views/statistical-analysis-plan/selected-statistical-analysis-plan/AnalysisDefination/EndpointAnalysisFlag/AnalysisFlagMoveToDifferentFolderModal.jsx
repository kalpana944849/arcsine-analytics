...
const DATA_ITEM_KEY = "SapAnalysisFlagGuid";
const SELECTED_FIELD = "selected";
const idGetter = getter(DATA_ITEM_KEY);

const AnalysisFlagMoveToDifferentFolderModal = ({ closeModal }) => {
    let expandObj = {};
    const sapCollectionData = JSON.parse(localStorage.getItem("dataAnalysisFlag")) || [];
    ...
    const columnsCategory = [
        {
            ...
            title: "Analysis Flag Name Short",
            expandable: true,
            width: "500px",
            cell: (props) => {
                return (
...
export default AnalysisFlagMoveToDifferentFolderModal;