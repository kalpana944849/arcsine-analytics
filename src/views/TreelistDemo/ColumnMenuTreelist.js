...
import {ColumnMenuNumericColumn, ColumnMenuTextColumn} from '@progress/kendo-react-data-tools';
import {TreeList, createDataTree, extendDataItem, filterBy, mapTree, orderBy} from '@progress/kendo-react-treelist';
...
const columns = [
    {
        ...
        title: 'Folder Id',
        width: '15px',
        columnMenu: ColumnMenuNumericColumn
    },
    {
        field: 'companyId',
        title: 'Company Id',
...
export default ColumnMenuTreelist