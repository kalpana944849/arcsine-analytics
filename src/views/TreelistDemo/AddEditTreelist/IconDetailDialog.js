  ...
  return (
    <>
      <Form
        render={(renderProps) => (
          <Dialog 
            title={`${selectedRow.standardComponentTreeLabel} Detail`}
          ...
          >
            ...
            <FieldWrapper>
              ...
              >
                <Label
                  editorId={"standardComponentUniqueId"}
                ...
                >
                  <p> {selectedRow.standardComponentUniqueId}</p>
                </div>
              </div>
            ...
            <FieldWrapper>
              ...
              >
                <Label
                  editorId={"standardComponentTreeLabel"}
                  className={"k-form-label"}
                >
                  {"Name :- "}
                </Label>
                ...
                >
                  <p > {selectedRow.standardComponentTreeLabel}</p>
                </div>
              </div>
            </FieldWrapper>
            <FieldWrapper>
